...
<head>
    ...
    <title>OLGA - Neuen Hersteller anlegen</title>
            ...
            <form action="{{ route('manufacturers.store') }}" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="herstellernummer" id="herstellernummer" class="form-control" value="{{ old('herstellernummer') }}" placeholder="z.B. 001">
                        @error('herstellernummer') <div class="error-msg">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        <label for="firmenname">Firmenname</label>
                        <input type="text" name="firmenname" id="firmenname" class="form-control" value="{{ old('firmenname') }}" required placeholder="Name des Herstellers">
                        @error('firmenname') <div class="error-msg">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        <label for="anrede">Anrede</label>
                        <input type="text" name="anrede" id="anrede" class="form-control" value="{{ old('anrede') }}" placeholder="z.B. Herr">
                    </div>

                    <div class="form-group">
                        <label for="vorname">Vorname</label>
                        <input type="text" name="vorname" id="vorname" class="form-control" value="{{ old('vorname') }}">
                    </div>

                    <div class="form-group">
                        <label for="nachname">Nachname</label>
                        <input type="text" name="nachname" id="nachname" class="form-control" value="{{ old('nachname') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="info@beispiel.de">
                ...
                <button type="submit" class="btn-save">
                    <i class="fas fa-plus"></i> Hersteller anlegen
                </button>
            </form>
        </div>
    </div>
